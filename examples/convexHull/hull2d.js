...
var Edge, Line2D, MathUtils, Rect, Triangle2D, Vec2, pex, _ref;
...
pex.sys.Window.create({
  ...
  quickHull: function(points) {
    var a, b, dividingEdge, dividingLine, edge, edgePoints, edges, end, i, idx, isLeft, j, maxX, minX, neg, nextEdge, notUsed, quickHullStep, result, start, swap, _i, _j, _ref1, _ref2, _ref3;
    ...
    quickHullStep = function(points, edgePoints, dividingLine, dividingEdge, depth) {
      var cleanSide, findFurthestPoint, idx, increasedSides, leftPoints, numEdgePoints, rightPoints;
      ...
      cleanSide = function(sidePoints) {
        var dividingEdgeA, dividingEdgeB, max, paIsLeft, paLine, paPoints, pbIsLeft, pbLine, pbPoints, projectedMaxPoint, resultA, resultB, triangle;
