...
function generate() {
  ...
  .then(execP('git clone http://github.com/vorg/pex-projects/'))
  .then(logP('moving projects up'))
  .then(execP('mkdir projects'))
  .then(execP('mv pex-projects/assets projects'))
  .then(execP('mv pex-projects/projects.json projects'))
