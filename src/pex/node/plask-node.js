...
define(['node-webgl'], function(WebGL) {
  ...
  var requestAnimFrame = document.requestAnimationFrame;
  ...
  function simpleWindow(obj) {
    ...
    console.log(obj.settings.width);
    var canvas = document.createElement('canvas', obj.settings.width, obj.settings.height, obj.settings.fullscreen);
