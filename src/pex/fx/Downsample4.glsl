...
void main() {  
  ...
  vec4 color = vec4(0.0);
  color += texture2D(tex0, vTexCoord + vec2(texel.x * -2.0, texel.y * -2.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x * -1.0, texel.y * -2.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x *  0.0, texel.y * -2.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x *  1.0, texel.y * -2.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x * -2.0, texel.y * -1.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x * -1.0, texel.y * -1.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x *  0.0, texel.y * -1.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x *  1.0, texel.y * -1.0));
  color += texture2D(tex0, vTexCoord + vec2(texel.x * -2.0, texel.y *  0.0));
