define(['pex/fx/FXGraph', 'lib/text!pex/fx/Blur3H.glsl', 'lib/text!pex/fx/Blur3V.glsl', 'pex/geom/Vec2'],
function(FXGraph, Blur3HGLSL, Blur3VGLSL, Vec2) {
  FXGraph.prototype.blur3 = function(options) {
    options = options || {};
